 ...
 */
export declare function makeInvoker<T>(functionOrClass: ClassOrFunctionReturning<T>, opts?: ResolverOptions<T>): (methodToInvoke: MethodName) => (ctx: any, ...rest: any[]) => any;
/**
 ...
 */
export declare function makeFunctionInvoker<T>(fn: FunctionReturning<T>, opts?: ResolverOptions<T>): (methodToInvoke: MethodName) => (ctx: any, ...rest: any[]) => any;
/**
 ...
 * @return {(methodToInvoke: string) => (ctx) => void}
 */
export declare function makeClassInvoker<T>(Class: Constructor<T>, opts?: ResolverOptions<T>): (methodToInvoke: MethodName) => (ctx: any, ...rest: any[]) => any;
/**
 ...
 * @return {(methodToInvoke: string) => (ctx) => void}
 */
export declare function makeResolverInvoker<T>(resolver: Resolver<T>): (methodToInvoke: MethodName) => (ctx: any, ...rest: any[]) => any;
/**
 * Injects dependencies into the middleware factory when the middleware is invoked.
 *
 * @param factory
 */
export declare function inject(factory: ClassOrFunctionReturning<any> | Resolver<any>): (ctx: any, ...rest: any[]) => any;
